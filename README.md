...
## دفتر الحسابات
دفتر أشخاص مستقل: له / عليه / تسديد، صافٍ محسوب تلقائيًا، سجل عمليات برصيد جارٍ لكل شخص،
ونظام عملات مرن يقبل عملات من إنشاء المستخدم (رمز اختياري أو بلا رمز).
التفاصيل في `docs/ACCOUNTS_BOOK.md`.
